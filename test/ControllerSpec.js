...
describe('controller', function () {
	...
	it('should show entries on start-up', function () {
		var todos = [{ title: 'my first todo', completed: false }];
		setUpModel(todos);
	...
	describe('routing', function () {
		...
		it('should show active entries', function () {
			var todos = [{ title: 'active todo', completed: false }];
			setUpModel(todos);
		...
		it('should show completed entries', function () {
			var todos = [{ title: 'completed todo', completed: true }];
			setUpModel(todos);
	...
	describe('toggle all', function () {
		it('should toggle all todos to completed', function () {
			...
			for (var i = 0; i < todos.length; i++) {
				expect(model.update).toHaveBeenCalledWith(todos[i].id, { completed: true }, jasmine.any(Function));
			}
		});
	});
	...
	it('should update the view', function () {
		...
		expect(view.render).toHaveBeenCalledWith('elementComplete', jasmine.any(Object));
	});
